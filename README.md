...
- [gitlab.com/tozd/go/fun](https://gitlab.com/tozd/go/fun) - A Go package that provides high-level abstraction to define functions with code (the usual way), data (providing examples of inputs and expected outputs which are then used with an AI model), or natural language description.
