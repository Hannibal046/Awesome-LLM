...
| ----- | ----- | ----- | :-----: |----- | :-----: | ----- | ----- |
| GPT 3.0 | 175B |primarily English|-| [api](https://openai.com/api/)|:x:|[PaLM: Scaling Language Modeling with Pathways]2020-05|[Language Models are Few-Shot Learners](https://arxiv.org/pdf/2005.14165.pdf)| 
| PaLM |  540B  |Multilingual+Code|-|:x:|:x:|2022-04|[PaLM: Scaling Language Modeling with Pathways]
## ChatGPT Evaluation
